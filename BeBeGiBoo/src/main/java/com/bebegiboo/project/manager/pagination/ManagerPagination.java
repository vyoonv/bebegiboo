package com.bebegiboo.project.manager.pagination;
...
public class ManagerPagination {
	...
	public ManagerPagination(int currentPage, int listCount) {
		super();
	...
	public ManagerPagination(int currentPage, int listCount, int limit, int pageSize) {
		super();
		this.currentPage = currentPage;
		this.listCount = listCount;
		this.limit = limit;
